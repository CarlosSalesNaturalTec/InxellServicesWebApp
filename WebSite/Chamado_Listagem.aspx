<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Chamado_Listagem.aspx.cs" Inherits="Chamado_Listagem" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Chamado Listagem</title>
...
<body>
       ...
       <div class="w3-container w3-border w3-round w3-padding-16 w3-light-gray" style="margin-left: 2%; margin-right: 2%">
        <small><i class="fa fa-calendar-check-o fa-2x"></i>&nbsp;&nbsp;Total de Chamados Solicitados:  
            <!--*******Customização*******-->
            <asp:Literal ID="lblTotalRegistros" runat="server"></asp:Literal></small>
        &nbsp;&nbsp;
        <button class="w3-btn w3-round w3-border w3-blue w3-right" onclick="NovoRegistro()"><i class="fa fa-plus"></i>&nbsp;Novo Usuario</button>
        <!--*******Customização*******-->
    </div>
    <br />
    ...
    <script type="text/javascript" src="scripts/codeChamado_Listagem.js"></script>
