<%@ Page Language="C#" AutoEventWireup="true" CodeFile="User_Listagem.aspx.cs" Inherits="user_listagem" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Usuario Listagem</title>
...
<body>
    ...
    <div class="w3-container w3-border w3-round w3-padding-16 w3-light-gray" style="margin-left: 2%; margin-right: 2%">
        <small><i class="fa fa-calendar-check-o fa-2x"></i>&nbsp;&nbsp;Total de Usuarios Cadastrados:  
            <!--*******Customização*******-->
    ...
    <script type="text/javascript" src="Scripts/codeUsuario_Listagem.js"></script>
